        ...
        <div class="flex h-screen">
            ...
            <div class="flex-1 p-8">
                ...
                <div class="bg-white p-4 shadow-md rounded-md">
                    ...
                    <form class="max-w-sm mx-auto" method="post" action="{{ route('createCategory') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="categoryDescription"
                                ...
                                placeholder = "Enter Category Description" cols="30" rows="10"></textarea>
                        </div>
                    ...
                    {{-- <form class="max-w-sm mx-auto" method="post" action="{{ route('createCategory') }}">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="name" id="name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="name@flowbite.com" name="categoryName" required>
                        </div>
                        <div class="mb-5">
                            <label for="message"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                                message</label>
                            <textarea id="message" rows="4" name="categoryDescription"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
